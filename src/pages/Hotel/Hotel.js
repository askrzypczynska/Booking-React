...
function Hotel(props) {
    ...
    return loading ? <LoadingIcon /> : (
        ...
        <div className="card-body">
          <img
            src={`https://loremflickr.com/420/180/architecture,building`}
            alt=""
            className="img-fluid img-thumbnail mb-4" />
  
          <p>Miasto: <b>{hotel.city}</b></p>
          <p>Dostępne pokoje: <b>{hotel.rooms}</b></p>
          <p className="lead">{hotel.desctription}</p>
